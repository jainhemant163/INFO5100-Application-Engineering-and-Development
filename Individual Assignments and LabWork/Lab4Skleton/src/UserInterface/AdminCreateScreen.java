...
public class AdminCreateScreen extends javax.swing.JPanel {
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        if(p2==null || p2.equals(""))
        {
            ...
            JOptionPane.showMessageDialog(null,"Re-type Password Column cannot be empty!");
            return;
        }
        
         if(!usernamePatternCorrect())
        {
            JOptionPane.showMessageDialog(null,"Username should of the form xxx_xxx@xxx.xxx");
            txtUser.setBorder(BorderFactory.createLineBorder(Color.RED));
            jLabel1.setForeground(Color.red);
            return;
        }
        ...
        {
            JOptionPane.showMessageDialog(null,"Password should be having at least 6 digits and contain at "
                                             + "least one upper case letter, one lower case letter, "
                                             + "one digit and one special character $, *, # or &.");
            txtPword.setBorder(BorderFactory.createLineBorder(Color.RED));
            jLabel2.setForeground(Color.red);
            return;
        }
         ...
         if(!passwordPatternCorrect())
        {
         ...
         if(!p1.equals(p2)){
            txtRePword.setBorder(BorderFactory.createLineBorder(Color.RED));
            jLabel3.setForeground(Color.red);
            JOptionPane.showMessageDialog(null,"Re-typed Password should be same as the Password!");
            return;
         }
        ...
        if(radioSupplier.isSelected())
        {
            ...
            cardLayout.previous(this.panelRight);
            ...
            for(Component cp : cps)
            {
                ...
                {
                    AdminMainScreen adm=(AdminMainScreen)cp;
...
//)
    ...
    private boolean passwordPatternCorrect() {
        Pattern p=Pattern.compile("^((?=.*\\d)(?=.*[A-Z])(?=.*[a-z])(?=.*\\W).{6,})$");
