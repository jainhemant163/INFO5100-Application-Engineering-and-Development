...
public class CreateProductJPanel extends javax.swing.JPanel {
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        //Validating the product name in the text field
        ...
        if(name == null || name.equals("")){
         ...
         //Validating the product available in the text field
        String productAvailable = txtAvailablity.getText();
        try{
            Integer.parseInt(productAvailable);
            
        }catch(NumberFormatException e){
            JOptionPane.showMessageDialog(null,"Please enter the number for the prduct available");
            return;
        }
        
         //Validating the product price in the text field
        String productPrice = txtPrice.getText();
        try{
            Integer.parseInt(productPrice);
            
        }catch(NumberFormatException e){
            JOptionPane.showMessageDialog(null,"Please enter the number for the prduct price");
            return;
        }
        
        //Check if the product description is empty or not
        ...
        JOptionPane.showMessageDialog(null,"Product created successfullys");
